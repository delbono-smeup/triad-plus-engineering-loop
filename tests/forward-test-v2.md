...
| --- | --- | --- |
| Runtime routing | Older/unconfigured Codex selects explicit dispatch; supported configured Codex selects async hook. | `runtime-forward-test.mjs`: capability cases. |
